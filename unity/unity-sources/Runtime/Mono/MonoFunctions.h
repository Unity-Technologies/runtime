...
DO_API(const char*, mono_field_get_name, (MonoClass* klass, MonoClassField * field))
DO_API(void, coreclr_field_get_name, (MonoClass* klass, MonoClassField* field, void* buffer, AssignString assign))
...
DO_API(void, coreclr_method_get_name, (MonoMethod* method, void* buffer, AssignString assign))
...
DO_API(void, coreclr_class_get_namespace, (MonoClass * klass, void* buffer, AssignString assign))
...
DO_API(void, coreclr_class_get_name, (MonoClass * klass, void* buffer, AssignString assign))

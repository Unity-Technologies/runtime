...
DO_API(void, coreclr_method_get_name, (MonoClass* klass, MonoMethod* method, void* buffer, AssignString assign))
DO_API(void, coreclr_method_full_name, (MonoClass* klass, MonoMethod* method, gboolean signature, void* buffer, AssignString assign))

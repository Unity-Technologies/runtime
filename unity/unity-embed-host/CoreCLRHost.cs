...
static unsafe partial class CoreCLRHost
{
    ...
    public static IntPtr array_new([NativeCallbackType("MonoDomain*")] IntPtr domain, [NativeCallbackType("MonoClass*")] IntPtr klass, [NativeWrapperType("guint32")] int n)
    ...
    public static IntPtr unity_array_new_2d([NativeCallbackType("MonoDomain*")] IntPtr domain, [NativeCallbackType("MonoClass*")] IntPtr klass,
        [NativeWrapperType("size_t")] int size0, [NativeWrapperType("size_t")] int size1)
    ...
    public static IntPtr unity_array_new_3d([NativeCallbackType("MonoDomain*")] IntPtr domain, [NativeCallbackType("MonoClass*")] IntPtr klass,
        [NativeWrapperType("size_t")] int size0, [NativeWrapperType("size_t")] int size1, [NativeWrapperType("size_t")] int size2)

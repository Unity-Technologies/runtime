...
struct HostStruct
{
    ...
    void (*coreclr_method_full_name)(MonoClass* klass, MonoMethod* method, gboolean signature, void* buffer, AssignString assignString);
    void (*coreclr_method_get_name)(MonoClass* klass, MonoMethod* method, void* buffer, AssignString assignString);
...
{
    char* method_name;
    coreclr_method_full_name(mono_method_get_class(method), method, signature, &method_name, AssignCoreString);
    return method_name;
}
...
{
    char* method_name;
    coreclr_method_get_name(mono_method_get_class(method), method, &method_name, AssignCoreString);
    return method_name;
}
...
// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API void EXPORT_CC coreclr_method_full_name(MonoClass* klass, MonoMethod* method, gboolean signature, void* buffer, AssignString assignString)
{
    GCX_PREEMP(); // temporary until we sort out our GC thread model
    return g_HostStruct->coreclr_method_full_name(klass, method, signature, buffer, assignString);
}

// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API void EXPORT_CC coreclr_method_get_name(MonoClass* klass, MonoMethod* method, void* buffer, AssignString assignString)
{
    GCX_PREEMP(); // temporary until we sort out our GC thread model
    return g_HostStruct->coreclr_method_get_name(klass, method, buffer, assignString);
}

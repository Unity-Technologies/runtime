...
struct HostStruct
{
    ...
    MonoObject* (*unity_mono_runtime_invoke)(MonoMethod* method, MonoObject* obj, int32_t nargs, MonoObject** args, MonoException** exception);
...
// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API MonoObject* EXPORT_CC unity_mono_runtime_invoke(MonoMethod* method, MonoObject* obj, int32_t nargs, MonoObject** args, MonoException** exception)
{
    GCX_PREEMP(); // temporary until we sort out our GC thread model
    return g_HostStruct->unity_mono_runtime_invoke(method, obj, nargs, args, exception);
}

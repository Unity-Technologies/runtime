...
struct HostStruct
{
    ...
    gboolean (*unity_method_is_generic)(MonoMethod* method);
...
// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API gboolean EXPORT_CC mono_unity_method_is_generic(MonoMethod* method)
{
    GCX_PREEMP(); // temporary until we sort out our GC thread model
    return g_HostStruct->unity_method_is_generic(method);
}

...
struct HostStruct
{
    ...
    void (*coreclr_field_get_name)(MonoClassField* field, void* buffer, AssignString assignString);
...
{
    char* field_name;
    coreclr_field_get_name(field, &field_name, AssignCoreString);
    return field_name;
}
...
// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API void EXPORT_CC coreclr_field_get_name(MonoClassField* field, void* buffer, AssignString assignString)
{
    GCX_PREEMP(); // temporary until we sort out our GC thread model
    return g_HostStruct->coreclr_field_get_name(field, buffer, assignString);
}

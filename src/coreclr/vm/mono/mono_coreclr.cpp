...
struct HostStruct
{
    MonoArray* (*array_new)(MonoDomain* domain, MonoClass* klass, int32_t n);
    ...
    MonoArray* (*unity_array_new_2d)(MonoDomain* domain, MonoClass* klass, int32_t size0, int32_t size1);
    MonoArray* (*unity_array_new_3d)(MonoDomain* domain, MonoClass* klass, int32_t size0, int32_t size1, int32_t size2);
};

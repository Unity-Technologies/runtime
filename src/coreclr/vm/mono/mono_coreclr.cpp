...
struct HostStruct
{
    ...
    void (*field_get_value)(MonoObject* obj, MonoClassField* field, void* value);
    void (*field_set_value)(MonoObject* obj, MonoClassField* field, void* grr);
    void (*field_static_get_value)(MonoVTable* obj, MonoClassField* field, void* value);
...
{
    return g_HostStruct->field_get_value(obj, field, value);
}

// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API void EXPORT_CC mono_field_set_value(MonoObject* obj, MonoClassField* field, void* grr)
{
    return g_HostStruct->field_set_value(obj, field, grr);
}

// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API void EXPORT_CC mono_field_static_get_value(MonoVTable* obj, MonoClassField* field, void* value)
{
    return g_HostStruct->field_static_get_value(obj, field, value);
}

...
struct HostStruct
{
    ...
    void (*coreclr_class_get_name)(MonoClass* klass, void* buffer, AssignString assignString);
    void (*coreclr_class_get_namespace)(MonoClass* klass, void* buffer, AssignString assignString);
    void (*coreclr_field_get_name)(MonoClass* klass, MonoClassField* field, void* buffer, AssignString assignString);
    void (*coreclr_method_full_name)(MonoMethod* method, gboolean signature, void* buffer, AssignString assignString);
    void (*coreclr_method_get_name)(MonoMethod* method, void* buffer, AssignString assignString);
    void (*coreclr_type_get_name_full)(MonoType* type, MonoTypeNameFormat format, void* buffer, AssignString assignString);
...
// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API void EXPORT_CC coreclr_class_get_name(MonoClass* klass, void* buffer, AssignString assignString)
{
    GCX_PREEMP(); // temporary until we sort out our GC thread model
    return g_HostStruct->coreclr_class_get_name(klass, buffer, assignString);
}

// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API void EXPORT_CC coreclr_class_get_namespace(MonoClass* klass, void* buffer, AssignString assignString)
{
    GCX_PREEMP(); // temporary until we sort out our GC thread model
    return g_HostStruct->coreclr_class_get_namespace(klass, buffer, assignString);
}

void AssignCoreString(void* buffer, void* utf16, int len)
{
    if (utf16 != NULL)
    {
...
{
    char* klass_name;
    coreclr_class_get_name(klass, &klass_name, AssignCoreString);
    return klass_name;
}
...
extern "C" EXPORT_API const char* EXPORT_CC mono_field_get_name(MonoClass* klass, MonoClassField *field)
{
    char* field_name;
    coreclr_field_get_name(klass, field, &field_name, AssignCoreString);
    return field_name;
}
...
{
    char* method_name;
    coreclr_method_get_name(method, &method_name, AssignCoreString);
    return method_name;
}
...
extern "C" EXPORT_API char* EXPORT_CC mono_type_get_name(MonoType *type)
{
    ...
    return mono_type_get_name_full(type, MonoTypeNameFormat::MONO_TYPE_NAME_FORMAT_REFLECTION);
}
...
// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API void EXPORT_CC coreclr_method_full_name(MonoMethod* method, gboolean signature, void* buffer, AssignString assignString)
{
    GCX_PREEMP(); // temporary until we sort out our GC thread model
    return g_HostStruct->coreclr_method_full_name(method, signature, buffer, assignString);
}
...
// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API void EXPORT_CC coreclr_field_get_name(MonoClass* klass, MonoClassField* field, void* buffer, AssignString assignString)
{
    GCX_PREEMP(); // temporary until we sort out our GC thread model
    return g_HostStruct->coreclr_field_get_name(klass, field, buffer, assignString);
}

// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API void EXPORT_CC coreclr_method_get_name(MonoMethod* method, void* buffer, AssignString assignString)
{
    GCX_PREEMP(); // temporary until we sort out our GC thread model
    return g_HostStruct->coreclr_method_get_name(method, buffer, assignString);
}
